...
function SectionHeading({
  ...
  return (
    <header className="relative max-w-4xl">
      {eyebrow ? (
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.26em] text-amber-200/85">
            {eyebrow}
          </p>
          <div
            className="mt-3 h-px w-14 bg-gradient-to-r from-amber-300/80 via-amber-400/35 to-transparent"
            aria-hidden
          />
        </div>
      ) : null}
      <h2
        ...
        className={cn(
          ...
          eyebrow
            ? "mt-5 text-3xl sm:text-4xl md:text-[2.85rem] md:leading-[1.1]"
            : "text-3xl sm:text-4xl md:text-[2.85rem] md:leading-[1.1]"
        )}
      >
        {title}
      </h2>
...
function OrbitalNetworkVisual({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M 80 120 Q 450 40 820 140"
        stroke="url(#moonshot-orbit-b)"
        strokeWidth="0.9"
        strokeDasharray="3 12"
        opacity="0.7"
      />
      <path
        d="M 120 400 Q 450 480 780 380"
        stroke="currentColor"
        strokeWidth="0.6"
    ...
    <li className="min-w-0">
      ...
      >
        ...
        <div className="relative flex items-center justify-between gap-3 border-b border-white/[0.06] pb-3">
          ...
          <span
            className="h-px flex-1 max-w-[4.5rem] bg-gradient-to-r from-amber-400/40 to-transparent"
            aria-hidden
          />
        </div>
        ...
        <p className="relative mt-3 flex-1 text-sm leading-relaxed text-muted-foreground sm:text-[0.9375rem]">
          {card.copy}
        </p>
      </div>
    </li>
  ...
  return (
    <div className="relative mt-16 sm:mt-20 md:mt-24">
      ...
      <div className="relative overflow-hidden rounded-[1.75rem] border border-amber-400/22 bg-gradient-to-br from-[rgb(12_16_26_/0.97)] via-[rgb(6_9_16_/0.96)] to-[rgb(2_4_10_/0.99)] shadow-[0_36px_120px_rgb(0_0_0_/0.55),inset_0_1px_0_rgb(255_255_255_/0.07)] backdrop-blur-md sm:rounded-[2rem]">
        <div
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_20%_0%,rgb(212_175_55_/0.18),transparent_50%)]"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_95%_85%,rgb(212_175_55_/0.08),transparent_45%)]"
          aria-hidden
        />
...
export function FiMarketingMoonshotSection({ section }: { section: HomePageContent["moonshot"] }) {
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_50%_-10%,rgb(212_175_55_/0.22),transparent_55%)]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_0%_50%,rgb(212_175_55_/0.08),transparent_42%)]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_100%_40%,rgb(30_58_95_/0.35),transparent_50%)]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_50%_100%,rgb(0_0_0_/0.75),transparent_55%)]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-amber-950/[0.06] to-[rgb(0_0_0_/0.35)]"
        aria-hidden
      />
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-32 md:py-40">
        <FadeIn>
          ...
          <ul
            className="relative mt-14 grid list-none grid-cols-1 gap-4 sm:mt-16 sm:grid-cols-2 sm:gap-5 lg:mt-20 xl:grid-cols-3"
            role="list"
          >
