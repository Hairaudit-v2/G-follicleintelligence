...
export function EnterpriseMarketingView() {
  return (
    <>
      ...
      >
        <FadeIn>
          <SectionHeading id={`${c.governance.id}-heading`} eyebrow={c.governance.eyebrow} title={c.governance.headline} />
      ...
      >
        <FadeIn>
          <SectionHeading id={`${c.useCases.id}-heading`} eyebrow={c.useCases.eyebrow} title={c.useCases.headline} />
      ...
      >
        <FadeIn>
          <SectionHeading id={`${c.capabilities.id}-heading`} eyebrow={c.capabilities.eyebrow} title={c.capabilities.headline} />
              ...
              <li key={card.title}>
                <FadeIn delay={0.03 * (i % 5)}>
                  <GlassCard variant="os" className="flex h-full min-h-[10.5rem] flex-col border-white/[0.06] sm:min-h-[11rem]">
                    ...
                    <p className="mt-4 text-sm font-semibold uppercase tracking-[0.1em] text-amber-100/95">{card.title}</p>
      ...
      >
        <FadeIn>
          <SectionHeading id={`${c.expansion.id}-heading`} eyebrow={c.expansion.eyebrow} title={c.expansion.headline} />
      ...
      >
        <FadeIn>
          <SectionHeading id={`${c.whyItMatters.id}-heading`} eyebrow={c.whyItMatters.eyebrow} title={c.whyItMatters.headline} />
