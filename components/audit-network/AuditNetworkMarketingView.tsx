  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 md:py-24">
          <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <FadeIn>
              <p className="text-[10px] font-semibold uppercase tracking-[0.34em] text-cyan-200/80 sm:text-[11px]">
                {c.hero.eyebrow}
              </p>
              <div
                className="mt-3 h-px w-14 bg-gradient-to-r from-cyan-300/60 via-cyan-400/20 to-transparent"
                aria-hidden
              />
              <h1
              ...
              <div className="mt-8 flex w-full max-w-md flex-col gap-3 sm:mt-10 sm:max-w-none sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
                ...
                <Button
                  ...
                  className={cn(
                    MARKETING_CTA_SECONDARY_CLASS,
                    "min-w-[12rem] hover:border-cyan-300/22"
                  )}
                >
            ...
            <FadeIn delay={0.08}>
              <div className="relative mx-auto w-full max-w-sm lg:mx-0 lg:max-w-none">
                <div
                  className="absolute -inset-3 rounded-[1.5rem] bg-gradient-to-br from-cyan-400/10 via-transparent to-slate-900/40 blur-2xl"
                  aria-hidden
                />
                <div className="relative overflow-hidden rounded-[1.35rem] border border-white/[0.09] bg-gradient-to-br from-white/[0.06] via-slate-950/[0.35] to-[rgb(2_6_12_/0.92)] p-5 shadow-[0_28px_80px_rgb(0_0_0_/0.5),inset_0_1px_0_rgb(255_255_255_/0.05)] backdrop-blur-md sm:p-6">
                  ...
                  <div className="mt-4 grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="hidden rounded-xl border border-dashed border-cyan-400/12 bg-slate-950/[0.35] p-3 sm:block">
                      <p className="font-mono text-[9px] font-semibold uppercase tracking-[0.18em] text-cyan-200/40">
                        Scorecard motif
                      </p>
                      <div className="mt-3 space-y-2">
                        {[72, 54, 88].map((w, i) => (
                          <div key={i} className="flex items-center gap-2">
                            <span className="w-5 font-mono text-[10px] text-cyan-200/25">
                              {i + 1}
                            </span>
                            <div className="h-1.5 flex-1 overflow-hidden rounded-full bg-white/[0.06]">
                              <div
                                className="h-full rounded-full bg-gradient-to-r from-cyan-400/35 to-cyan-200/10"
                                style={{ width: `${w}%` }}
                              />
                            </div>
                          </div>
                ...
                <FadeIn delay={0.04 * (i % 4)}>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <span className="font-mono text-[10px] font-semibold tabular-nums tracking-[0.12em] text-cyan-200/35">
                        ISSUE
                      </span>
                      <span
                        className="h-px flex-1 bg-gradient-to-r from-cyan-400/15 to-transparent"
                        aria-hidden
                      />
                    </div>
      ...
      >
        <FadeIn>
          <SectionHeading
            id={`${c.hairAudit.id}-heading`}
            tone="audit"
            eyebrow={c.hairAudit.eyebrow}
            title={c.hairAudit.headline}
          />
      ...
      >
        <FadeIn>
          <SectionHeading
            id={`${c.measures.id}-heading`}
            tone="audit"
            eyebrow={c.measures.eyebrow}
            title={c.measures.headline}
          />
            ...
            {c.measures.cards.map((card, i) => (
              <li key={card.title}>
                <FadeIn delay={0.03 * (i % 5)}>
                  <GlassCard
                    variant="os"
                    className="flex h-full flex-col !rounded-[1.25rem] border-cyan-500/[0.05] !p-5 hover:border-cyan-400/22 sm:!p-5"
                  >
                    <div className="flex items-center gap-2 border-b border-white/[0.06] pb-2.5">
                      ...
                      <span
                        className="h-px flex-1 bg-gradient-to-r from-cyan-400/18 via-white/[0.04] to-transparent"
                        aria-hidden
                      />
                    </div>
      ...
      >
        <FadeIn>
          <SectionHeading
            id={`${c.qualityIntel.id}-heading`}
            tone="audit"
            eyebrow={c.qualityIntel.eyebrow}
            title={c.qualityIntel.headline}
          />
            ...
            <div className="rounded-[1.75rem] border border-cyan-500/[0.1] bg-gradient-to-br from-white/[0.04] via-slate-950/[0.2] to-cyan-950/[0.06] p-7 shadow-[0_28px_90px_rgb(0_0_0_/0.5),inset_0_1px_0_rgb(255_255_255_/0.05)] backdrop-blur-md sm:rounded-[2rem] sm:p-10 md:p-12">
              <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                <div>
                  ...
                  <div
                    className="mt-3 h-px w-14 bg-gradient-to-r from-cyan-300/55 via-cyan-400/18 to-transparent"
                    aria-hidden
                  />
                  <h2
                ...
                <div className="flex w-full max-w-md flex-col gap-3 lg:max-w-none lg:justify-self-end">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className={cn(MARKETING_CTA_SECONDARY_CLASS, "hover:border-cyan-300/22")}
                  >
