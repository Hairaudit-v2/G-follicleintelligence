      ...
      {items.map((item, i) => (
        <li key={item.title}>
          <FadeIn delay={0.04 * (i % 3)}>
            <GlassCard
              variant="problem"
              className="group flex h-full flex-col transition-[border-color,transform] duration-300 hover:-translate-y-0.5"
            >
      ...
      {items.map((item, i) => (
        <li key={item.title}>
          <FadeIn delay={0.03 * (i % 4)}>
            <GlassCard
              variant="default"
              className="group flex h-full flex-col border-white/[0.07] transition-[border-color,transform] duration-300 hover:-translate-y-0.5 hover:border-amber-400/18"
            >
              <span className="font-mono text-[9px] font-semibold uppercase tabular-nums tracking-[0.16em] text-amber-200/45">
                {String(i + 1).padStart(2, "0")}
              </span>
              <h3 className="mt-2 font-display text-sm font-semibold leading-snug text-foreground sm:text-base">
                {item.title}
              </h3>
      ...
      {items.map((item, i) => (
        <li key={item}>
          <FadeIn delay={0.03 * (i % 4)}>
            <GlassCard
              variant="default"
              className="flex h-full flex-col border-cyan-500/[0.08] bg-gradient-to-br from-white/[0.04] via-slate-950/[0.04] to-cyan-950/[0.04]"
            >
              <div className="flex items-start gap-3">
                <span
                  aria-hidden
  ...
  return (
    <>
        ...
        <FadeIn>
          ...
          <GlassCard className="mx-auto mt-12 max-w-3xl border-amber-400/14">
            <p className="text-center text-base leading-relaxed text-foreground sm:text-lg">
              {c.evidenceGap.closingStatement}
            </p>
          </GlassCard>
        </FadeIn>
      </Section>
      ...
      >
        <FadeIn>
          <SectionHeading
            id={`${c.researchDomains.id}-heading`}
            eyebrow={c.researchDomains.eyebrow}
            title={c.researchDomains.headline}
          />
      ...
      >
        <FadeIn>
          ...
          <p className="mt-10 text-[11px] font-semibold uppercase tracking-[0.22em] text-amber-200/75">
            {c.globalRegistry.registryFieldsLabel}
          </p>
          ...
          <GlassCard className="mx-auto mt-12 max-w-2xl border-amber-400/14 text-center">
            <p className="font-display text-xl font-semibold tracking-tight text-foreground sm:text-2xl">
              {c.globalRegistry.closingStatement}
            </p>
          </GlassCard>
        </FadeIn>
      </Section>
      ...
      >
        <FadeIn>
          ...
          />
          <p className="mt-10 text-[11px] font-semibold uppercase tracking-[0.22em] text-violet-200/75">
            {c.aiInfrastructure.opportunitiesLabel}
          </p>
          ...
          <GlassCard className="mx-auto mt-12 max-w-3xl border-violet-400/14">
            <p className="text-center text-base leading-relaxed text-foreground sm:text-lg">
              {c.aiInfrastructure.closingStatement}
            </p>
          </GlassCard>
        </FadeIn>
      </Section>
          ...
          <div className="mt-12 grid gap-10 lg:grid-cols-[1fr_0.85fr] lg:items-center lg:gap-14">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-amber-200/75">
                {c.multicentreNetwork.capabilitiesLabel}
              </p>
            ...
            <ResearchNetworkViz
              nodes={c.multicentreNetwork.networkNodes}
              centerLabel={c.multicentreNetwork.networkCenterLabel}
            />
          </div>
        </FadeIn>
      </Section>
