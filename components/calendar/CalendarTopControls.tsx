...
export function CalendarTopControls({
  ...
  const rangeCls = isFiOs
    ? "hidden text-sm font-medium text-[var(--fi-cal-ws-text,#f1f5f9)] lg:block"
  ...
  return (
    <>
      <div
        className={cn("flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", shell)}
      >
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className={cn(
              ...
              isFiOs
                ? cn(
                    "border text-slate-400 hover:border-cyan-500/20 hover:text-cyan-100",
                    filterShell
                  )
        ...
        <p
          className={cn(
            ...
            isFiOs ? "text-slate-200" : "text-slate-300"
          )}
        >
          {rangeTitle}
        </p>
