...
export function PatientImageCategoryBadge({ category }: { category: PatientImageCategory }) {
  return (
    <span className="inline-flex items-center rounded-full bg-white/[0.06] px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-slate-200 ring-1 ring-inset ring-slate-400/30">
