...
import type {
  PatientProfileFoundationData,
  PatientProfileBookingCard,
} from "@/src/lib/patients/patientProfileLoader";
...
export function PatientBookingsCard({
  tenantId,
  data,
}: {
  tenantId: string;
