...
export function ClinicalHairLossScaleFields({
  ...
  return (
    <div className="space-y-4 rounded-lg border border-slate-200 bg-slate-50/60 p-3">
      <p className="text-xs font-semibold uppercase tracking-wide text-slate-600">Pattern & classification</p>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <label className="block text-xs font-medium text-slate-800 sm:col-span-2">
