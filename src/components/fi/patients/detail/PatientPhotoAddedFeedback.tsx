...
export function PatientPhotoAddedFeedback() {
  ...
  return (
    <div
      className={cn(
        "pointer-events-auto fixed right-4 z-[100] flex w-[min(100vw-2rem,20rem)] items-start gap-2 rounded-xl border border-emerald-200/90 bg-emerald-50/95 px-3 py-2.5 text-emerald-950 shadow-lg backdrop-blur-sm",
