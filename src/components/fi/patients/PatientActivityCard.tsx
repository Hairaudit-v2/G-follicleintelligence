  ...
  return (
    <section className="rounded border border-white/[0.08] bg-[#0F1629]/80 backdrop-blur-md p-4 shadow-lg shadow-black/40">
      ...
      <p className="mt-1 text-xs text-gray-500">
        Read-only CRM activity tied to this patient&apos;s leads, cases, or explicit patient_id.
        Clinical detail edits are not mirrored here — a patient-native activity stream remains
        deferred (Stage 4B).
      </p>
              ...
              <p className="text-xs text-slate-400">
                ...
                {a.lead_id ? (
                  ...
                  <>
                    {" · "}
                    <Link
                      href={`/fi-admin/${tenantId}/patients/${data.foundationPatientId}`}
                      className="text-blue-300 hover:underline"
                    >
                      Patient record
                    </Link>
