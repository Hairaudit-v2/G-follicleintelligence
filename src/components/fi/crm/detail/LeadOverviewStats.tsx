  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
      <div className={crmLeadCardClass}>
        ...
        <p className="mt-1 text-lg font-semibold text-gray-900">{opportunity.treatmentValueLabel ?? "—"}</p>
      ...
      <div className={crmLeadCardClass}>
        ...
        <p className="mt-1 text-lg font-semibold text-gray-900">{opportunity.conversionProbabilityLabel ?? "—"}</p>
      ...
      <div className={crmLeadCardClass}>
        ...
        <p className="mt-1 text-sm font-medium text-gray-900">{nextAction.label}</p>
        {nextAction.atIso ? (
      ...
      <div className={crmLeadCardClass}>
        ...
        <p className="mt-1 text-lg font-semibold text-gray-900">
          {openTaskCount} <span className="text-sm font-normal text-gray-600">open tasks</span>
        </p>
