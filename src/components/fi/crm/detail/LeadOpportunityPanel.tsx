...
export function LeadOpportunityPanel({
  ...
  return (
    <section className={crmLeadCardClass}>
      <h2 className="mb-2 text-sm font-semibold text-slate-100">Opportunity details</h2>
      <dl className="grid gap-2 text-sm sm:grid-cols-2">
        ...
        <div>
          ...
          <dd className="text-slate-100">{lead.priority?.trim() || "—"}</dd>
        </div>
        <div>
        ...
        {opportunity.opportunityNotes ? (
          <div className="sm:col-span-2">
            ...
            <dd className="whitespace-pre-wrap text-slate-200">{opportunity.opportunityNotes}</dd>
          </div>
        ) : null}
      </dl>
