...
export function DashboardAddLeadAction() {
  return (
    ...
    >
      ...
      <div className="text-sm font-semibold tracking-tight text-slate-100 sm:text-base">New enquiry</div>
      <p className="mt-1.5 flex-1 text-sm leading-relaxed text-slate-400">Capture a new enquiry without leaving the dashboard.</p>
