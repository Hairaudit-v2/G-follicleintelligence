...
export function ConsultationPreparationChecklistPanel({
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      ...
      >
        <p className="mb-3 rounded-md border border-amber-200/80 bg-amber-50 px-3 py-2 text-xs text-amber-950 dark:border-amber-500/35 dark:bg-amber-950/40 dark:text-amber-50/95">
        ...
        {!checklist ? (
          <p className="text-sm text-slate-600 dark:text-slate-300">
            ...
            <Link href={patientTwinHref} className="font-medium text-sky-700 underline hover:text-sky-800 dark:text-sky-400">
              Patient Twin
            </Link>{" "}
          ...
          <div className="space-y-3 text-sm">
            <div className="flex flex-wrap gap-2">
              ...
              {checklist.delay_recommended ? (
                <span className="rounded-full bg-rose-100 px-2.5 py-0.5 text-xs font-semibold text-rose-900 dark:bg-rose-950/60 dark:text-rose-100">
            ...
            {checklist.consultation_summary?.trim() ? (
              <div>
                ...
                <p className="mt-1 text-slate-800 dark:text-slate-200">{checklist.consultation_summary}</p>
              </div>
            ) : null}
            ...
            <p className="text-xs text-slate-500">
              ...
              <Link href={patientTwinHref} className="font-medium text-sky-700 underline dark:text-sky-400">
                Open Patient Twin
              </Link>
            </p>
          </div>
