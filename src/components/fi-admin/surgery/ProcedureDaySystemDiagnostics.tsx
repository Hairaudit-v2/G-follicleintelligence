      ...
      <div className="space-y-6 border-t border-white/[0.06] px-5 py-5 sm:px-6 sm:py-6">
        ...
        <DashboardCard className="border-white/[0.06] bg-[#0c1220]/40 p-4 sm:p-5">
          <SectionHeader
            ...
            description="Aggregate surgery day summary from board model."
            className="mb-3"
          />
        ...
        <DashboardCard className="border-white/[0.06] bg-[#0c1220]/40 p-4 sm:p-5">
          <SectionHeader
            title="Procedure progress buckets"
            description="fi_case_procedures status distribution."
            className="mb-3"
          />
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <DashboardCard className="border-white/[0.06] bg-[#0c1220]/40 p-4 sm:p-5">
          <SectionHeader
            ...
            description={`${flat.length} surgery bookings loaded for today.`}
            className="mb-3"
          />
