  ...
  return (
    <FiCard>
      ...
      {canAttemptSend && pharmacies.length > 0 ? (
        <div className="mt-4 space-y-3 rounded border border-white/[0.08] bg-white/[0.03] p-3">
      ...
      <div className="mt-6">
        <h3 className="text-sm font-semibold text-slate-100">Transmission log</h3>
        {transmissions.length === 0 ? (
          <p className="mt-2 text-sm text-slate-400">No pharmacy transmissions yet.</p>
        ) : (
          <ul className="mt-2 divide-y divide-white/[0.08] border border-white/[0.08] rounded-lg bg-[#0F1629]/80 backdrop-blur-md">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {tx.status === "pending" && tx.method === "manual_export" ? (
                      <button
                        type="button"
                        disabled={pending}
                        className="text-xs font-medium text-emerald-300 hover:underline disabled:opacity-50"
                    ...
                    {tx.status === "sent" ? (
                      <button
                        type="button"
                        disabled={pending}
                        className="text-xs font-medium text-slate-200 hover:underline disabled:opacity-50"
