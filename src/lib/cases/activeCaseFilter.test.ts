...
const MUST_FILTER: Array<{ file: string; label: string; minCount: number }> = [
  ...
  { file: "src/lib/payments/paymentRecordMutations.server.ts",                   label: "paymentRecordMutations",    minCount: 1 },
  { file: "src/lib/clinicalNotes/clinicalNotesMutations.server.ts",              label: "clinicalNotesMutations",    minCount: 1 },
  { file: "src/lib/medicationOs/medicationOsMutations.server.ts",                label: "medicationOsMutations",     minCount: 1 },
  { file: "src/lib/consultationForms/consultationFormMutations.server.ts",       label: "consultationFormMutations", minCount: 1 },
  { file: "src/lib/revenueOs/revenueInvoiceMutations.server.ts",                 label: "revenueInvoiceMutations",   minCount: 2 },
  { file: "src/lib/fi-os/clinicalIntelligence.server.ts",                        label: "clinicalIntelligence",      minCount: 1 },
  { file: "src/lib/fi/foundation/foundationOsDashboardRead.server.ts",           label: "foundationOsDashboardRead", minCount: 1 },
  { file: "src/lib/fi/foundation/patientRecord.ts",                              label: "patientRecord",             minCount: 1 },
  { file: "src/lib/fiAdmin/clinicOsGlobalSearchLoader.server.ts",                label: "clinicOsGlobalSearch",      minCount: 1 },
  ...
  { file: "src/lib/patients/patientOsDashboardLoader.server.ts",                 label: "patientOsDashboard",        minCount: 2 },
  ...
  { file: "src/lib/patients/timeline/patientTimelineServer.ts",                  label: "patientTimeline",           minCount: 1 },
  ...
  { file: "app/api/tenants/[tenantId]/cases/[caseId]/route.ts",                  label: "api/cases/[caseId]",        minCount: 1 },
  { file: "app/api/tenants/[tenantId]/cases/[caseId]/run-model/route.ts",        label: "api/run-model",             minCount: 1 },
  { file: "app/api/tenants/[tenantId]/cases/[caseId]/submit/route.ts",           label: "api/submit",                minCount: 2 },
  { file: "app/api/tenants/[tenantId]/cases/[caseId]/uploads/route.ts",          label: "api/uploads",               minCount: 1 },
...
for (const entry of MUST_NOT_FILTER) {
  ...
  test("[must-not-filter] " + label, () => {
    ...
    assert.ok(
      ...
      file + " is intentionally unfiltered -- .is(deleted_at, null) must not appear near fi_cases here"
    );
  });
}
