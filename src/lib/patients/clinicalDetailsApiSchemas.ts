...
export const patientClinicalDetailsPatchBodySchema = z
  .object({
    ...
    primary_hair_concern: boundedText(CLINICAL_DETAILS_TEXT_MAX.primary_hair_concern, "primary_hair_concern"),
    treatment_interest: boundedText(CLINICAL_DETAILS_TEXT_MAX.treatment_interest, "treatment_interest"),
    hair_loss_duration: boundedText(CLINICAL_DETAILS_TEXT_MAX.hair_loss_duration, "hair_loss_duration"),
    ...
    current_medications: boundedText(CLINICAL_DETAILS_TEXT_MAX.current_medications, "current_medications"),
    allergies: boundedText(CLINICAL_DETAILS_TEXT_MAX.allergies, "allergies"),
    contraindications: boundedText(CLINICAL_DETAILS_TEXT_MAX.contraindications, "contraindications"),
