...
export const serverEnvSchema = z.object({
  ...
  FI_HUBSPOT_INCREMENTAL_BACKUP_CRON_SECRET: optionalString,
  FI_HUBSPOT_INCREMENTAL_BACKUP_ENABLED: optionalString,
  FI_HUBSPOT_INCREMENTAL_BACKUP_TENANT_ID: optionalString,
  FI_HUBSPOT_INCREMENTAL_BACKUP_INTEGRATION_ID: optionalString,
  FI_HUBSPOT_RECOVERY_ACTOR_AUTH_USER_ID: optionalString,
  ...
  HAIRAUDIT_PROJECTION_SERVICE_TOKEN: optionalString,
  HAIRAUDIT_PROJECTION_REQUEST_SIGNING_SECRET: optionalString,
  HAIRAUDIT_PROJECTION_CALLBACK_SIGNING_SECRET: optionalString,
  HAIRAUDIT_PROJECTION_CALLBACK_BASE_URL: optionalHttpUrl,
  HAIRAUDIT_PROJECTION_FIOS_TENANT_ID: optionalString,
  HAIRAUDIT_PROJECTION_FIOS_CLINIC_ID: optionalString,
  FI_PRE_SURGERY_PROJECTION_PROVIDER: optionalString,
  FI_PRE_SURGERY_PROJECTION_ALLOW_STUB_IN_PRODUCTION: optionalString,
  FI_PRE_SURGERY_PROJECTION_ENABLED: optionalString,
  FI_PRE_SURGERY_PROJECTION_HAIRAUDIT_ENABLED: optionalString,
  FI_PRE_SURGERY_PROJECTION_CLINIC_ENABLED: optionalString,
  FI_PRE_SURGERY_PROJECTION_PATIENT_SHARING_ENABLED: optionalString,
  FI_PRE_SURGERY_PROJECTION_REQUIRE_HMAC: optionalString,
  FI_PRE_SURGERY_PROJECTION_TIMESTAMP_SKEW_SECONDS: optionalString,
  FI_PRE_SURGERY_PROJECTION_STORAGE_BUCKET: optionalString,
  FI_PRE_SURGERY_PROJECTION_SYNC_BUDGET_MS: optionalString,
  ...
  FI_ENABLE_HLI_TRICHOSCOPY: optionalString,
  HLI_TRICHOSCOPY_API_BASE_URL: optionalHttpUrl,
  HLI_TRICHOSCOPY_SERVICE_KEY: optionalString,
  HLI_TRICHOSCOPY_SIGNING_SECRET: optionalString,
  HLI_TRICHOSCOPY_WEBHOOK_SECRET: optionalString,
  HLI_TRICHOSCOPY_REQUEST_TIMEOUT_MS: optionalString,
  HLI_TRICHOSCOPY_MAX_RETRIES: optionalString,
  ...
  FI_IMAGING_REQUIRE_GRAFT_TRAY_CAPTURE: optionalString,
  FI_IMAGING_ENABLE_GRAFT_TRAY_AI_COUNT: optionalString,
  FI_IMAGING_GRAFT_TRAY_AI_PROVIDER: optionalString,
  FI_IMAGING_GRAFT_TRAY_COUNT_TOLERANCE_PERCENT: optionalString,
...
export function collectCrossEnvValidationIssues(env: NodeJS.ProcessEnv = process.env): EnvIssue[] {
  ...
  for (const issue of [
    ...
    minSecretIssue(
      ...
      g("FI_IMAGING_AI_ANALYSIS_CRON_SECRET"),
      16
    ),
    ...
    minSecretIssue(
      "PATIENT_VISUAL_SUMMARY_SHARE_SECRET",
      g("PATIENT_VISUAL_SUMMARY_SHARE_SECRET"),
      16
    ),
