...
export const FI_OS_NAV_1B_DOMAIN_BY_ID: Record<string, FiOsNav1BMappingEntry> = {
  ...
  crm: { domain: "Pipeline", notes: "Pipeline workspace at /crm" },
  consultations: {
    domain: "Clinical",
    alternateDomain: "Pipeline",
    notes: "Live consultation workspace",
  },
  ...
  "pathology-email-routes": {
    domain: "Settings",
    notes: "Admin configuration under clinical labs",
  },
