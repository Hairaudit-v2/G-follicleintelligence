...
function inboundRow(partial: Partial<PathologyInboundDocumentRow> = {}): PathologyInboundDocumentRow {
  return {
    ...
    suggested_patient_id: partial.suggested_patient_id ?? null,
    confirmed_patient_id: partial.confirmed_patient_id ?? null,
    match_confidence: partial.match_confidence ?? null,
    match_evidence: partial.match_evidence ?? {},
    extracted_patient_name: partial.extracted_patient_name ?? null,
    extracted_dob: partial.extracted_dob ?? null,
    extracted_mrn: partial.extracted_mrn ?? null,
    promoted_result_id: partial.promoted_result_id ?? null,
    extraction_status: partial.extraction_status ?? "not_started",
    extraction_job_id: partial.extraction_job_id ?? null,
    draft_result_id: partial.draft_result_id ?? null,
    ready_for_review_at: partial.ready_for_review_at ?? null,
    inbound_email_message_id: partial.inbound_email_message_id ?? null,
    email_from: partial.email_from ?? null,
    email_subject: partial.email_subject ?? null,
    email_source_label: partial.email_source_label ?? null,
    email_attachment_dedup_hash: partial.email_attachment_dedup_hash ?? null,
