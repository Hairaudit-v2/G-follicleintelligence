...
export const CLINIC_OS_SHELL_NAV_MODULES: ClinicOsShellNavModuleDefinition[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        permissionHint: {},
        description:
          "Front-desk command center — today’s clinic, arrival queue, alerts, and surgery prep.",
      },
      {
        id: "tomorrow-board",
        label: "Tomorrow",
...
export function getClinicOsShellActiveNavId(pathname: string, base: string): string | null {
  ...
  if (first === "reception-os") return "reception-os";
  if (first === "reception-board") return "reception-board";
