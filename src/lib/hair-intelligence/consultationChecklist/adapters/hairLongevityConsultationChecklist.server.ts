...
export type GenerateHairLongevityConsultationChecklistParams = {
...
export async function generateHairLongevityConsultationChecklistAndPersist(
  params: GenerateHairLongevityConsultationChecklistParams
