...
import { getPatientDocumentForGateway } from "@/src/lib/patientJourneyControl/patientGatewayDocuments.server";
...
export async function GET(
  ...
  try {
    ...
    const result = await getPatientDocumentForGateway(gateCtx.context, params.packetId);
