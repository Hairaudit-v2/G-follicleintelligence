...
import { listPatientDocumentsForGateway } from "@/src/lib/patientJourneyControl/patientGatewayDocuments.server";
...
export async function GET(req: Request) {
  try {
    ...
    const result = await listPatientDocumentsForGateway(gate.context);
