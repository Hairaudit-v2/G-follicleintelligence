...
import { acceptPatientQuoteForGateway } from "@/src/lib/patientJourneyControl/patientGatewayQuotes.server";
...
export async function POST(
  ...
  try {
    ...
    const result = await acceptPatientQuoteForGateway(gateCtx.context, params.quoteId);
