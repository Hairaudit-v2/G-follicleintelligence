 ...
 * FI-PATIENT-APP-P1 — list patient quotes.
 */
...
import { listPatientQuotesForGateway } from "@/src/lib/patientJourneyControl/patientGatewayQuotes.server";
...
export async function GET(req: Request) {
  try {
    ...
    const result = await listPatientQuotesForGateway(gate.context);
