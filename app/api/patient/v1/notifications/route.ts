 ...
 * FI-PATIENT-APP-P1 — in-app notification feed.
 */
...
import { listPatientNotificationsForGateway } from "@/src/lib/patientJourneyControl/patientNotificationFeed.server";
...
export async function GET(req: Request) {
  try {
    ...
    const result = await listPatientNotificationsForGateway(gate.context);
