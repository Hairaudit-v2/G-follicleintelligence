 ...
 */
import { handleLinkCalendarOsPatient } from "@/src/lib/calendar/calendarOsWritebackRoutes.server";
...
export async function POST(
  ...
  return handleLinkCalendarOsPatient(tenantId.trim(), eventId.trim(), req);
}
