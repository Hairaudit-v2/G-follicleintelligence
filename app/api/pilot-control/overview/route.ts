/**
 * GET /api/pilot-control/overview?programmeId=...
 */
import { resolvePilotControlRequestContext } from "@/src/lib/pilotControl/api/resolvePilotControlRequestContext.server";
import { assembleOverviewResponse } from "@/src/lib/pilotControl/api/pilotControlServices.server";
import {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const payload = await assembleOverviewResponse(ctx);
