  ...
  return (
    <>
      <PageHero
        ...
        title="Preview the Follicle Intelligence intelligence layer."
        subtitle="Executive, clinical, and operations views built for benchmarking, quality control, and training visibility."
      />
      <Section>
        <FadeIn>
          <div className="fi-panel rounded-2xl p-8 md:p-10">
            <div className="grid gap-5 md:grid-cols-3">
              {[
                ...
                ["Evidence Confidence Score", "98.4%", "Stable"],
            ...
            <div className="mt-6 rounded-xl border border-border/70 bg-background/60 p-6">
              <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">
                Demo Grid (Representative)
              </p>
              <div className="mt-4 fi-grid rounded-lg border border-border/60 p-5">
                <div className="grid gap-3 md:grid-cols-2">
                  {[
                    "Practitioner benchmark ranking",
                    "Outcome trend consistency chart",
                    "Confidence and evidence density indicators",
                    "Training opportunity clustering",
                  ].map((item) => (
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Button asChild>
                <Link href="/contact?intent=demo">Book Live Dashboard Walkthrough</Link>
              </Button>
