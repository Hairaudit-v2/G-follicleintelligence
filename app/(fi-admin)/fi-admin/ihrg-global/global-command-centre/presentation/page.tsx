...
/** Friendly slug entry point: /fi-admin/ihrg-global/global-command-centre/presentation */
export default async function IhrgGlobalCommandCentrePresentationSlugRedirectPage() {
  noStore();
