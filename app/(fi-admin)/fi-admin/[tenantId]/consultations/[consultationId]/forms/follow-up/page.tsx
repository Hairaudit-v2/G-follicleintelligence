...
import { ensureInRoomFollowUpReviewConsultationFormInstance } from "@/src/lib/consultationForms/consultationFormMutations.server";
import { assertFiTenantPortalAccess } from "@/src/lib/fiOs/fiOsPortalGate.server";

export const metadata = {
  title: "Follow-up / review consultation",
  robots: { index: false, follow: false },
};

export const dynamic = "force-dynamic";

export default async function FollowUpReviewGuidedFormPage({
  params,
}: {
  ...
  const instance = await ensureInRoomFollowUpReviewConsultationFormInstance(tid, cid);
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      <p className="mb-4 text-sm text-slate-600">
        ...
        <Link href={`/fi-admin/${tid}/consultations/${cid}/forms/repair`} className="font-semibold text-emerald-800 underline">
          repair consultation
        </Link>
        .
      </p>
