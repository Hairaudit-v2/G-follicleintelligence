  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      <p className="mb-4 text-sm text-slate-400">
        Consultations pathway 4 — dedicated repair / revision intake (prior surgery audit, donor &
        recipient risk, HairAudit + Surgery routing). For primary transplant planning, use the{" "}
        <Link
