...
export default async function FiAdminReportsPerformancePage({
  params,
  searchParams,
}: {
  ...
  try {
    ...
    return (
      <div className="p-4 sm:p-6">
        <InfoNotice variant="danger" title="Clinic performance could not load">
          <p className="text-sm">The performance workspace failed to load. Check server logs.</p>
