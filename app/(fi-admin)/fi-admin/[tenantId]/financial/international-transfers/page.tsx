      ...
      <FinancialOsSubPageHeader
        ...
        description={
          <>
            ...
            <code className={financialOsClasses.code}>international_transfer</code> payment pathways — instructions, proof of payment, reconciliation, FX
            variance review, and settlement tracking without live Wise/bank/SWIFT APIs.
          </>
        }
      />
