      ...
      <FinancialOsSubPageHeader
        ...
        description={
          <>
            ...
            <code className={financialOsClasses.code}>super_release</code> payment pathways — eligibility review, documents, clinical letters, submission,
            approval, and funds release tracking without live provider APIs.
          </>
        }
      />
