    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-[#94A3B8]">
          ...
          <span className="text-[#CBD5E1]">reminder consent</span> on their profile, booking
          create/update rebuilds the pending job queue (48h / 24h / immediate acknowledgement).{" "}
          <span className="text-[#CBD5E1]">Lead created</span> and{" "}
          <span className="text-[#CBD5E1]">post-consult</span> triggers enqueue from CRM and
          ConsultationOS (completed) respectively. Delivery is stubbed until ESP/SMS wiring; process
          jobs with the cron API using{" "}
