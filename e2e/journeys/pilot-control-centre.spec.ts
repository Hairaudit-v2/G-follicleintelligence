/**
 * FI-CONTROLLED-PILOT-CONTROL-CENTRE-1A.5 — E2E acceptance journeys (Playwright).
 * Fail-closed access + empty-cohort honesty. Live role matrix against production is partial.
 */
import { expect, test } from "@playwright/test";

const TENANT = process.env.FI_E2E_TENANT_ID?.trim() || "c2615b95-b707-4485-aa5f-be8f78ec868a";

test.describe("Pilot Control Centre 1A.5 @smoke", () => {
