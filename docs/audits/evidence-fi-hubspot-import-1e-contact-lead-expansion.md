...
**Verdict:** AMBER — E1–E9 GREEN; expansion paused for E10 approval
...
**FI-HUBSPOT-IMPORT-1E Batches E1–E9: GREEN**

Nine consecutive reconciled production expansion batches completed with the
patient-protection gate held. Further batches (E10) require operator approval.

E1–E8 checkpoint (`ec4541d3`) was committed and pushed before E9 apply.

### Post-E9 inventory (write-free)

| Metric | Value |
|--------|------:|
| Total source contacts | 4,750 |
| Already linked / applied | 3,624 |
| Ready to link | 972 |
...
Production batch:
`bba7d442-d39d-4b26-a279-fba6fefe1605`

Checksum:
`b646685805d32c11730c8d3d7a54e190d80621ebf2d106092a79b0f06239fe68`

Identity method:
`person_source_id_single_lead` (all 500)

Prior batch gate:
- priorBatchId `a0e2bdc3-1e7b-4681-a685-5ccb6fefdfad` (E8) reconciled, unexplained 0
...
### Cumulative counts (after E9)

| Entity | Before 1E | After E9 |
|--------|----------:|---------:|
| `fi_crm_leads` | 4706 | 4706 |
| `fi_patients` | 829 | 829 |
| contact→lead external mappings | 24 | 3624 |

Expansion-only mappings created: **3600** (E1–E9)

### E9 controls verified

- E8 reconciliation gate passed before E9 apply
- E1–E8 checkpoint committed/pushed (`ec4541d3`) before E9 apply
...
- rollback preview isolates exactly 500 E9 mappings; zero blocked
- patient count unchanged; zero side effects
- HubSpot backup watermark unchanged (`2026-07-16T03:45:02.366+00:00`)

### Exact next step

**Approve Batch E10** (up to 500 contacts, link_existing_lead only) after reviewing E9 evidence.
...
- `docs/audits/.tmp-import-1e-e9-select.json`
- `docs/audits/.tmp-import-1e-e9-preview.json`
- `docs/audits/.tmp-import-1e-e9-apply.json`
- `docs/audits/.tmp-import-1e-e9-reconcile.json`
- `docs/audits/.tmp-import-1e-e9-replay.json`
- `docs/audits/.tmp-import-1e-e9-rollback-preview.json`
- `docs/audits/.tmp-import-1e-e9-gate.json`
- `docs/audits/.tmp-import-1e-post-e9-inventory.json`
