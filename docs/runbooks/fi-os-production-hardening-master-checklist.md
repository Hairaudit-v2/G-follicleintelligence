...
- [x] **DB + Storage restore drill** — E4 PASS + E5 **AMBER** 2026-07-14 (14/14 object checksums; signed URL PASS; unsigned private DENIED). Independent long-term Storage backup still undefined; E6 verifier/cleanup outstanding — [`fi-security-restore-drill-1.md`](../security/fi-security-restore-drill-1.md); [`fi-os-storage-backup-restore-drill.md`](fi-os-storage-backup-restore-drill.md).
