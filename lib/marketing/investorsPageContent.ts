...
export const INVESTORS_PAGE_CONTENT = {
  ...
  marketOpportunity: {
    ...
    cards: [
      { title: "Global hair restoration market", body: "A multi-billion dollar sector spanning surgical and non-surgical treatment" },
      { title: "Billions in annual market size", body: "Sustained growth across established and emerging markets worldwide" },
      { title: "Thousands of clinics worldwide", body: "Independent operators, franchise groups, and enterprise networks" },
      { title: "Rapidly growing international demand", body: "Cross-border patient flows and expanding provider networks" },
      { title: "Increasing patient lifetime value", body: "Longitudinal care pathways from consultation through long-term outcomes" },
      { title: "Growing non-surgical treatment sector", body: "Medical therapies complementing and extending surgical volumes" },
      { title: "Increasing global medical tourism", body: "International patients seeking quality-assured restoration medicine" },
      { title: "Expanding franchise clinic groups", body: "Standardised brands scaling across regions and markets" },
    ],
  ...
  fragmentation: {
    ...
    cards: [
      ...
      { title: "Surgical spreadsheets", body: "Critical procedural data lost at the point of care" },
      { title: "Disconnected education systems", body: "Training separated from clinical performance" },
      { title: "Unstructured outcome tracking", body: "Results rarely audited or benchmarked objectively" },
      { title: "No benchmark infrastructure", body: "No shared standards for comparing clinical quality" },
      { title: "No shared intelligence systems", body: "Each clinic learns in isolation from every other" },
    ],
  ...
  verticalInfrastructure: {
    ...
    headline: "General software creates convenience. Vertical infrastructure creates defensibility.",
    description:
    ...
    horizontal: {
      ...
      items: ["CRM", "Scheduling", "Email automation", "Pipeline management", "Reporting dashboards"],
    },
    vertical: {
  ...
  platformEconomics: {
    ...
    description: "As clinics adopt connected intelligence systems, platform replacement becomes increasingly difficult.",
    retentionCards: [
      { title: "Patient records connected historically", body: "Longitudinal intelligence that cannot be replicated elsewhere" },
      { title: "Surgical data stored permanently", body: "Procedural records linked to outcomes and audit trails" },
      { title: "Outcome audits linked longitudinally", body: "Structured evidence spanning the full patient journey" },
      { title: "Staff training connected to competency", body: "Workforce performance tied to certification and outcomes" },
      { title: "Financial intelligence connected to operations", body: "Revenue correlated with clinical and operational quality" },
      { title: "Cross-clinic benchmarking becomes valuable", body: "Comparative intelligence unavailable outside the network" },
      { title: "Historical intelligence becomes irreplaceable", body: "Years of structured data create compounding switching costs" },
    ],
