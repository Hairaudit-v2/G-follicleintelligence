/**
 * Copy and structure for `/partners` — strategic ecosystem partnership narrative.
...
export const PARTNERS_PAGE_CONTENT = {
  hero: {
    ...
    headline: "Building The Future Of Hair Restoration Together",
    subheadline:
      "The future of hair restoration medicine will not be built by isolated clinics operating independently.",
    supportingCopy: [
      "It will be built through connected intelligence networks, shared standards, measurable outcomes, global education systems, and strategic collaboration.",
  ...
  whyPartnerships: {
    id: "partners-why-partnerships",
    eyebrow: "Ecosystem transformation",
    headline: "Transformation requires connected ecosystems",
    description:
      "No single organisation can transform a global medical industry alone. The next generation of healthcare infrastructure will emerge through connected partnerships that share intelligence, improve standards, and accelerate innovation.",
    cards: [
      {
        title: "Clinical infrastructure partnerships",
        body: "Multi-clinic groups and enterprise operators connecting operational intelligence across locations, protocols, and outcomes.",
      },
      {
        title: "Education and certification partnerships",
        body: "Training institutions and academies linking competency measurement directly to long-term clinical performance.",
      },
      {
        title: "Research and intelligence partnerships",
        body: "Research organisations contributing to structured datasets that unlock new treatment efficacy and outcome studies.",
      },
      {
        title: "Global expansion partnerships",
        body: "Distributors, franchise operators, and international groups building shared standards across markets and regions.",
      },
    ],
    closingStatement: "Industry transformation happens through ecosystems, not isolated companies.",
  },

  whoWePartnerWith: {
    id: "partners-who-we-partner-with",
    eyebrow: "Strategic alignment",
    headline: "Designed for strategic industry leaders",
    description:
      "Our partnership framework is designed for organisations committed to long-term infrastructure relationships and measurable industry improvement.",
    categories: [
      "Multi-clinic enterprise groups",
      "Hair transplant franchise organisations",
      "Independent premium clinic groups",
  ...
  clinicGroupPartnerships: {
    id: "partners-clinic-groups",
    eyebrow: "Enterprise infrastructure",
    headline: "Enterprise clinic infrastructure partnerships",
    description:
  ...
  educationPartnerships: {
    ...
    eyebrow: "Measurable training",
    headline: "The future of training must become measurable",
    description:
      "Medical education systems should connect directly with competency and long-term performance measurement.",
    infrastructure: [
      "Procedure participation tracking",
      "Competency progression systems",
      "Certification frameworks",
      "Performance benchmarking",
      "Continuous education infrastructure",
  ...
  deviceTechnologyPartnerships: {
    id: "partners-device-technology",
    eyebrow: "Connected technology",
    headline: "Connected technology creates better medicine",
    description:
  ...
  globalStandardisation: {
    id: "partners-global-standardisation",
    eyebrow: "Shared standards",
    headline: "The industry needs shared standards",
    description:
  ...
  longTermVision: {
    id: "partners-long-term-vision",
    eyebrow: "Global network",
    headline: "Building a global intelligence network",
    description:
      "Our long-term vision is to help connect every major stakeholder in hair restoration medicine into one continuously improving infrastructure network.",
    participants: [
      "Clinics",
      "Surgeons",
      "Nurses",
    ...
    closingStatement: "Every connected participant strengthens the entire ecosystem.",
  },

  finalCta: {
    id: "partners-final-cta",
    eyebrow: "Strategic collaboration",
    headline: "Partnerships accelerate transformation",
    supportingCopy: [
      "The future of hair restoration medicine will be defined by organisations willing to help build better infrastructure, better standards, and better intelligence systems.",
